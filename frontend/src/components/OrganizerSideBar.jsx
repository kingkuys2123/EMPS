...
function UserSideBar() {
    ...
    return (
        <div>
            <Drawer sx={{ width: 275, flexShrink: 0, "& .MuiDrawer-paper": {width: 275, boxSizing: "border-box", color: "white", backgroundColor: "#C63f47", overflow: "hidden" } }} variant="permanent" anchor="left">
